...
namespace AssetBundleBrowser.AssetBundleModel
{
    ...
    public static class Model
    {
        ...
        {
            if (!(name.StartsWith("Assets/") || name.StartsWith("Packages/") || name.StartsWith("Resources/unity_builtin_extra") || name == "Library/unity default resources"))
                return false;
        ...
        static private void FindBundleIcons()
        {
            ...
            var packagePath = System.IO.Path.GetFullPath("Packages/com.saro.xasset");
            if (System.IO.Directory.Exists(packagePath))
            {
                s_bundleIcon = (Texture2D)AssetDatabase.LoadAssetAtPath("Packages/com.saro.xasset/Editor/GUI/Icons/ABundleBrowserIconY1756Basic.png", typeof(Texture2D));
                s_sceneIcon = (Texture2D)AssetDatabase.LoadAssetAtPath("Packages/com.saro.xasset/Editor/GUI/Icons/ABundleBrowserIconY1756Scene.png", typeof(Texture2D));
            }
        }
    }
}
